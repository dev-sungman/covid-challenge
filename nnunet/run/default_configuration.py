...
def get_default_configuration(network, task, name, network_trainer, 
    ...
    output_folder_name = join(network_training_output_dir, network, task, network_trainer + "__" + plans_identifier, name)
